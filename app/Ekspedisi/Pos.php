...
class Pos implements BaseEkspedisi{
    /**
     * Key
     * Auth for RajaOngkir
     * @var string
    ...
    public function info()
    {
        return [
            ...
            "version" => "1.0",
            "author" => "viandwi24",
            "description" => "Plugin POS INDONESIA untuk Cek Ongkir dan Resi."
        ];
    }
    ...
    public function calculate($origin, $destination, $weight)
    {
        ...
        $option = [
            ...
            CURLOPT_POSTFIELDS => "origin=$origin_id&destination=$destination_id&weight=$weight&courier=pos",
